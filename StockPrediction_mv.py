...
def pre_process():
    ...
    stock_data[['Volume', 'Close']] = config.scaler.fit_transform(stock_data[['Volume', 'Close']])
...
#         return tf.contrib.rnn.DropoutWrapper(config.lstm_cell, output_keep_prob=config.keep_prob)
